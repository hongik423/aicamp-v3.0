...
• 🤖 **AI 생산성향상** - 업무효율 40-60% 향상 (정부 100% 지원)
• 🏭 **공장/부동산 경매** - 투자비 35-50% 절약, 임대료 완전 해소
• 🚀 **기술창업 지원** - 평균 5억원 자금 확보, 사업화 성공률 82%
• 🏆 **인증지원** - 연간 5천만원 세제혜택, 취득률 92%
• 🌐 **웹사이트 구축** - 매출 300-500% 증대, SEO 상위노출 보장
...
---
💡 **예시 질문:**
"우리 회사 AI 생산성 향상 방법이 궁금해요"
"BM ZEN 사업분석으로 매출을 늘리고 싶어요"
"AI & n8n 교육 프로그램에 대해 알려주세요"`,
      sender: 'bot',
      timestamp: new Date()
    };
