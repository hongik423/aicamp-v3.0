...
이후경 경영지도사 소개:
      현대그룹에서 8년, 삼성생명에서 10년, 그리고 10년간 200여 개 기업을 직접 지도해온 베테랑 AI 교육 전문가입니다. AI CAMP 교장이자 AI 기술 교육 전문가로 활동하며, 기업과 개인의 AI 역량 강화를 통한 디지털 혁신을 지원하고 있습니다.
...
BM ZEN 사업분석, AI 생산성혁신, 공장경매, 기술창업, 인증지원, 웹사이트구축 등 어떤 도움이 필요하신지 010-9251-9743으로 직접 전화주세요. 확실한 성과를 만들어드릴 자신 있어요!`;
      ...
      fallbackResponse = `안녕하세요! AI CAMP 교장 이후경입니다.
...
저희 AI CAMP에서는 6가지 핵심 서비스로 기업들을 돕고 있어요.
