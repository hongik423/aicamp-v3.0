...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-10 w-full items-center justify-between rounded-xl border border-input/60 bg-white/100 backdrop-blur-sm px-3 py-2 text-sm ring-offset-background focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:border-ring focus:bg-white/100 focus:backdrop-blur-none focus:shadow-md disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        'shadow-2xl border-gray-200 bg-white/100 backdrop-blur-sm',
        className,
      )}
      position={position}
      sideOffset={4}
