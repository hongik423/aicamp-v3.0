...
export const healthcareMedicalCaseDetails: { [key: string]: SuccessCaseDetail } = {
  ...
  'clinic-operations': {
    ...
    icon: Stethoscope,
    color: 'green',
    heroImage: 'https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?q=80&w=2091&auto=format&fit=crop',
    companyInfo: {
      industry: '내과/가정의학과',
      employees: '25명',
      revenue: '연 매출 35억원',
  ...
  'pharmacy-automation': {
    ...
    icon: Pill,
    color: 'purple',
    heroImage: 'https://images.unsplash.com/photo-1587370560942-ad2a04eabb6d?q=80&w=2070&auto=format&fit=crop',
    companyInfo: {
      industry: '약국',
      employees: '85명',
      revenue: '연 매출 120억원',
  ...
  'dental-clinic': {
    ...
    icon: Activity,
    color: 'blue',
    heroImage: 'https://images.unsplash.com/photo-1606811841689-23dfddce3e95?q=80&w=2074&auto=format&fit=crop',
    companyInfo: {
      industry: '치과',
      employees: '120명',
      revenue: '연 매출 180억원',
