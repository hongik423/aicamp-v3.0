...
export const financeInsuranceCaseDetails: { [key: string]: SuccessCaseDetail } = {
  ...
  'securities-trading-automation': {
    ...
    icon: TrendingUp,
    color: 'indigo',
    heroImage: 'https://images.unsplash.com/photo-1518186233392-c232efbf2373?w=1200&h=800&fit=crop&crop=center',
  ...
  'fintech-lending-platform': {
    ...
    icon: Globe,
    color: 'cyan',
    heroImage: 'https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?w=1200&h=800&fit=crop&crop=center',
  ...
  'asset-management-robo-advisor': {
    ...
    icon: PiggyBank,
    color: 'green',
    heroImage: 'https://images.unsplash.com/photo-1553729459-efe14ef6055d?w=1200&h=800&fit=crop&crop=center',
