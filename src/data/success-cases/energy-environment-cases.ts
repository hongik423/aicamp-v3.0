...
export const energyEnvironmentCaseDetails: { [key: string]: SuccessCaseDetail } = {
  'renewable-energy-management': {
    ...
    icon: Sun,
    color: 'yellow',
    heroImage: '/images/benchmark2/AI 탄소중립 통합 관리 시스템.png',
    companyInfo: {
      industry: '신재생에너지 발전',
      employees: '2,300명',
      revenue: '연 매출 3.8조원',
  ...
  'waste-management': {
    ...
    icon: Recycle,
    color: 'green',
    heroImage: '/images/benchmark2/AI 순환경제 폐기물 관리 시스템.png',
    companyInfo: {
      industry: '폐기물 처리',
      employees: '1,200명',
  ...
  'water-treatment': {
    ...
    icon: Droplet,
    color: 'blue',
    heroImage: '/images/benchmark2/AI 스마트 물 관리 플랫폼.png',
    companyInfo: {
      industry: '수자원 관리',
      employees: '4,500명',
      revenue: '연 매출 2.8조원',
  ...
  'environmental-consulting': {
    ...
    icon: Globe,
    color: 'emerald',
    heroImage: '/images/benchmark2/AI 환경영향평가 자동화 플랫폼.png',
    companyInfo: {
      industry: '환경 서비스',
      employees: '2,100명',
      revenue: '연 매출 1.2조원',
