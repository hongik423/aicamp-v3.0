...
export const retailServiceCaseDetails: { [key: string]: SuccessCaseDetail } = {
  ...
  'wholesale-supply-chain': {
    ...
    icon: Truck,
    color: 'green',
    heroImage: 'https://images.unsplash.com/photo-1566576912321-d58ddd7a6088?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    companyInfo: {
      industry: '물류/도매',
      employees: '2,800명',
      revenue: '연 매출 12조원',
  ...
  'restaurant-cafe-smart': {
    ...
    icon: Coffee,
    color: 'brown',
    heroImage: 'https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    companyInfo: {
      industry: '외식/카페',
      employees: '2,500명',
